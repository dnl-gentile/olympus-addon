...
-- CallbackHandler-1.0 (Ace3, BSD) is also embedded here so that a /reload picks it up
-- even on a client started before libs/CallbackHandler-1.0 existed. LibStub keeps a single copy.
